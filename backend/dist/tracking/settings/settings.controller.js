...
let SettingsController = class SettingsController {
    ...
    set(res, session, req, settings) {
        ...
        return this.settings.createOrUpdate(Object.assign(Object.assign({}, settings), { shop_domain: session.currentShop }))
            .then((settings) => {
            return res.json(settings);
        })
            .catch((error) => {
...
__decorate([
    common_1.Post(),
    nest_shopify_1.Roles('shopify-staff-member'),
    __param(0, common_1.Res()), __param(1, common_1.Session()), __param(2, common_1.Req()), __param(3, common_1.Body('settings')),
    __metadata("design:type", Function),
