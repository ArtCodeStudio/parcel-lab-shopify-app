  ...
  components: {
    parcelLabSettings: {
      ...
      preferCheckoutShippingMethodLabel:
        'Versuche den Kurier aus der Versandmethode herzuleiten',
      ...
      languageOverrideHeading: 'Sprach-Overrides',
      languageOverrideInfo:
        'Hier können Sie festlegen, dass für bestimmte Locales andere Sprach-Templates verwendet werden (wenn Sie z.B. noch kein Template für eine Sprache erstellt haben)',
      languageOverrideFromLabel: 'von',
      languageOverrideToLabel: 'nach',
      deleteLanguageOverrideLabel: 'Löschen',
      addLanguageOverrideLabel: 'Sprach-Override hinzufügen',
